...
# Since we have 807 apps, we choose 280 below to make sure 280 * 3 > 807,
# otherwise it will lead to the threshold problem
...
# the 2nd parameter 1.5*X is the threshold we choose to apply
# when forming flat clusters, the bigger the threshold, the less the clusters
ind = sch.fcluster(Z, 1.2*X.max(), 'distance') 
print ind
